<script lang="ts">
	...
	import sveld from '$lib/components/KTable.svelte?raw&sveld';

	export let data: PageData;
</script>

<svelte:head>
	<title>KUI Table</title>
	<meta name="description" content="WIP - Kilo UI Table" />
</svelte:head>

<ComponentPage {sveld}>
	<svelte:fragment slot="header">Table</svelte:fragment>
