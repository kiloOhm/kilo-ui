<script lang="ts">
	...
	import sveld from '$lib/components/KCheckbox.svelte?raw&sveld';

	export let data: PageData;
</script>

<svelte:head>
	<title>KUI Checkbox</title>
	<meta name="description" content="WIP - Kilo UI Checkbox" />
</svelte:head>

<ComponentPage {sveld}>
	<svelte:fragment slot="header">Checkbox</svelte:fragment>
