<script lang="ts">
	...
	import sveld from '$lib/components/KDivider.svelte?raw&sveld';

	export let data: PageData;
</script>

<svelte:head>
	<title>KUI Divider</title>
	<meta name="description" content="WIP - Kilo UI Divider" />
</svelte:head>

<ComponentPage {sveld}>
	<svelte:fragment slot="header">Divider</svelte:fragment>
